...
total <- merge(T_cell,Myeloid_cell)
table(total$MM3)
table(total$TISSUE)
...
cellchat <- createCellChat(object = data.input, meta = meta, group.by = "MM3")
...
cellchat <- setIdent(cellchat, ident.use = "MM3") # set "labels" as default cell identity
